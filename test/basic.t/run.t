...
Note that the parens are only added when necessary.
  ...
  (Par
     [(Disj (
         (Par
            [(Seq [(Assign (a.b, 1)); (Assign (b.c, 2)); (Assign (c.d, 3))]);
              (Assign (a.b, {1})); (Assign (a.b, [1]));
              (Assign (a.b, f(a, 1, 2))); (Assign (a.b, {a: 1}));
              Send {from = s; to_ = r; msg = m(a=1, b=2)};
              (Imply (1, (Seq [(Assign (a.b, 1)); (Assign (b.c, 2))])));
              (Forall (a, b, (Seq [(Assign (a.b, 1)); (Assign (c.a, 2))])))]),
         (Assign (a.a, 1))));
       (Seq [(Par [(Assign (a.a, 1)); (Assign (a.b, 2))]); (Assign (a.c, 3))]);
       (Seq [(Disj ((Assign (a.a, 1)), (Assign (a.b, 2)))); (Assign (a.c, 3))]);
       (Seq
          [(Forall (a, b, (Seq [(Assign (a.b, 1)); (Assign (c.a, 2))])));
            (Assign (a.a, 1))]);
       (Assign (a.a, a & b | c))])
